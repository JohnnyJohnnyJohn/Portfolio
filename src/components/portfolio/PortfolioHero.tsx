...
export function PortfolioHero() {
	return (
		<section className="relative z-10 w-screen overflow-hidden md:px-6 md:pt-40 md:pb-1 lg:px-0">
			...
			<div
				aria-hidden="true"
				className="pointer-events-none absolute inset-x-0 bottom-0 z-20 hidden h-50 md:block"
				style={{
					background:
						"linear-gradient(to bottom, rgba(8, 8, 8, 0), var(--portfolio-bg) 60%)",
				}}
			/>
			<a
				href="#work"
				className="absolute bottom-19.5 left-1/2 z-30 hidden -translate-x-1/2 text-[#f2f2f2]/80 md:block min-[1920px]:bottom-28"
			>
				<span className="sr-only">Scroll down</span>
				<ArrowDown className="scroll-anim" size={44} strokeWidth={2} />
			</a>
			<MobileHero />
		</section>
	);
...
function DesktopHero() {
	return (
		<div className="relative mx-auto hidden w-full max-w-220.5 md:block min-[1440px]:max-w-261 min-[1920px]:max-w-360">
			<BorderGlow
				className="overflow-hidden rounded-3xl border-white/5 p-2 outline-1 -outline-offset-1 outline-white/5 shadow-[inset_0_0_8px_rgba(0,0,0,.4),0_0_60px_rgba(0,0,0,.2),0_30px_120px_rgba(0,0,0,.8)] min-[1920px]:rounded-[36px] min-[1920px]:p-3 min-[1920px]:shadow-[inset_0_0_10px_rgba(0,0,0,.3),0_0_60px_rgba(0,0,0,.3),0_60px_180px_rgba(0,0,0,1)]"
			...
			>
				<div
					aria-hidden="true"
					className="pointer-events-none rounded-2xl absolute inset-0 z-0 bg-[radial-gradient(circle_farthest-side_at_50%_0,rgba(242,242,242,.4),transparent)] min-[1920px]:rounded-3xl"
				/>
				<div className="relative z-10 overflow-hidden rounded-2xl border border-white/30 shadow-[inset_0_0_10px_rgba(0,0,0,.1),0_0_12px_rgba(0,0,0,.4)] backdrop-blur-[20px] min-[1920px]:rounded-3xl min-[1920px]:shadow-[inset_0_0_15px_rgba(0,0,0,.1),0_0_20px_rgba(0,0,0,.3)]">
