...
function DesktopHero() {
	return (
		<div className="relative mx-auto hidden w-full max-w-220.5 md:block min-[1440px]:max-w-261 min-[1920px]:max-w-360">
			<div className="relative overflow-hidden rounded-[24px] bg-[radial-gradient(circle_farthest-side_at_50%_0,rgba(242,242,242,.2),transparent)] p-2 outline outline-1 -outline-offset-1 outline-white/15 shadow-[inset_0_0_8px_rgba(0,0,0,.4),0_0_60px_rgba(0,0,0,.2),0_30px_120px_rgba(0,0,0,.8)] min-[1920px]:rounded-[36px] min-[1920px]:p-3 min-[1920px]:shadow-[inset_0_0_10px_rgba(0,0,0,.3),0_0_60px_rgba(0,0,0,.3),0_60px_180px_rgba(0,0,0,1)]">
				<div className="overflow-hidden rounded-[16px] border border-white/30 shadow-[inset_0_0_10px_rgba(0,0,0,.1),0_0_12px_rgba(0,0,0,.4)] backdrop-blur-[20px] min-[1920px]:rounded-[24px] min-[1920px]:shadow-[inset_0_0_15px_rgba(0,0,0,.1),0_0_20px_rgba(0,0,0,.3)]">
					<div className="relative z-10 flex h-10 items-center justify-between rounded-t-[16px] bg-linear-to-r from-white/10 via-white/50 to-white/10 pr-3 pl-5 shadow-[0_10px_20px_4px_rgba(0,0,0,.2)] backdrop-blur-[40px] min-[1920px]:h-14 min-[1920px]:pr-4 min-[1920px]:pl-7">
					...
					<div className="relative flex flex-col bg-[#101010]/70 px-14 pt-20 pb-48 min-[1440px]:px-[72px] min-[1440px]:pt-24 min-[1440px]:pb-[200px] min-[1920px]:px-[88px] min-[1920px]:pt-[120px] min-[1920px]:pb-[280px]">
						<div className="relative z-10 flex flex-col gap-16 min-[1440px]:gap-[72px] min-[1920px]:gap-24">
							<h1
								className="max-w-[752px] text-[4.875rem] font-medium leading-[.9] tracking-tight text-[#f2f2f2] min-[1440px]:max-w-[900px] min-[1440px]:text-8xl min-[1920px]:max-w-[1264px] min-[1920px]:text-[132px]"
							...
							<div className="grid grid-cols-2 gap-6 min-[1440px]:gap-12 min-[1920px]:gap-[88px]">
								<div />
						...
						<ArrowDown
							className="absolute scroll-anim bottom-[78px] left-1/2 -translate-x-1/2 text-[#f2f2f2]/80 min-[1920px]:bottom-28"
							size={44}
							strokeWidth={2}
						/>
					</div>
