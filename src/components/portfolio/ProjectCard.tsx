...
export function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    <BorderGlow
      className="group w-full rounded-3xl border-white/15 p-2 outline-1 -outline-offset-1 outline-[#f2f2f2]/5 shadow-[0_40px_80px_rgba(0,0,0,.5)] transition-shadow duration-500 md:hover:shadow-[0_48px_110px_rgba(0,0,0,.62),0_0_90px_rgba(242,242,242,.08)] min-[1920px]:rounded-[36px] min-[1920px]:p-3"
